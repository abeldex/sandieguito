					...
					<div class="m-content">
						...
						<div class="m-portlet m-portlet--mobile">
							<div class="m-portlet__head">
								...
								<div class="m_datatable_remi"></div>
								</div>
						</div>
					    ...
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					        <form id="nuevo_operador" method="POST" action="remisiones/insertar.php">
					          ...
					          <div class="form-group">
					            <label for="fecha" class="form-control-label">Hora Llegada Origen:</label>
						            <div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group date' id='m_datetimepicker_2'>
												<input type='text' class="form-control m-input" readonly placeholder="Seleccione la hora" name="hora_llegada"/>
												<span class="input-group-addon">
					          ...
					          <div class="form-group">
					            <label for="fecha" class="form-control-label">Hora Salida Origen:</label>
						             <div class="col-lg-4 col-md-9 col-sm-12">
											<div class='input-group date' id='m_datetimepicker_2'>
												<input type='text' class="form-control m-input" readonly placeholder="Seleccione la hora" name="hora_salida"/>
												<span class="input-group-addon">
													<i class="la la-calendar-check-o glyphicon-th"></i>
												</span>
											</div>
					          ...
					          <div class="form-group">
					            <label for="fecha" class="form-control-label">Cargado en:</label>
					          ...
					          <div class="form-group">
					            <label for="chofer" class="form-control-label">Operador:</label>
						            <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" name="chofer">
						            <!--select para los permisionarios-->
						            <?php
					           ...
					           <div class="form-group">
					            <label for="fecha" class="form-control-label">Placas Camion:</label>
						            <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" name="camion">
						            <!--select para los permisionarios-->
						            <?php
										...
										{
											unset($id, $name);
										    $id = $row['placas_camion'];
										    $name = $row['numero_camion']; 
